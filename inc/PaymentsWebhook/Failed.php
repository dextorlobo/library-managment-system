...
class Failed {
	...
	public function init() {
		...
		add_action( 'thl_payment_failed_callback', array( $this, 'thl_payment_failed_method' ), 10, 2 );
	}

	public function thl_payment_failed_method( $palyload, $headers ) {
		...
		do_action( 'thl_payment_failed_after_update_status', $order_details );
	}
}
